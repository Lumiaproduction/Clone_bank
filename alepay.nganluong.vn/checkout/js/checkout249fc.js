...
$(document).ready(function() {
    ...
    function getFeeCardNumber(cardNumber) {
        $.ajax({
            url: alepayRequest.baseUrl + 'card/calculate-fee/' + alepayRequest.token,
            type: 'post',
            data: {
            ...
            success: function (response) {
                ...
                if (response.status == 'fail') {
                    ...
                    if (response.is_mc_cbs_2 == true){
                        var continueData = {
                            AcsUrl: response.data.termUrl,
                            Payload: response.data.paReq,
    ...
    $('#btn-otp-accept').click(function(e) {
        ...
        if (!otp) {
            ...
            $.ajax({
                url: alepayRequest.baseUrl + 'atm/submit-otp-atm/' + alepayRequest.token,
                type: 'post',
                data: {
                    _csrf: alepayRequest.csrf,
                    otp: otp,
                    authUrl: authUrl,
                    bankCode: alepayRequest.bankCode,
                },
                dataType: "json",
                beforeSend: function () {
    ...
    $('.btn-cancel-order').click(function (e) {
        ...
        $.ajax({
            url: alepayRequest.baseUrl + 'cancel-request/' + alepayRequest.token,
            type: 'post',
            data: {
                _csrf: alepayRequest.csrf
            },
    ...
    function getPeriods(cardNumber) {
        $.ajax({
            url: alepayRequest.baseUrl + 'installment/get-periods/' + alepayRequest.token,
            type: 'post',
            data: {
                _csrf: alepayRequest.csrf,
                cardNumber: cardNumber,
    ...
    $('#citistep2-resend-otp').click(function (e) {
        ...
        $.ajax({
            url: alepayRequest.baseUrl + 'citibank/resend-otp/' + alepayRequest.token,
            type: 'post',
            data: {
                _csrf: alepayRequest.csrf,
            },
    ...
    $('#btn-cancel-transaction').click(function (e) {
        ...
        $.ajax({
            url: alepayRequest.baseUrl + 'cancel-transaction/' + alepayRequest.token,
            type: 'post',
            data: {
                _csrf: alepayRequest.csrf
            },
    ...
    $('#submit-bank-review').click(function(e) {
        ...
        $.ajax({
            url: alepayRequest.baseUrl + 'card/bank-review/' + alepayRequest.token,
            type: 'post',
            data: {
                _csrf: alepayRequest.csrf,
    ...
    $('#submit-cmnd-review').click(function (e) {
        ...
        $.ajax({
            url: alepayRequest.baseUrl + 'card/cmnd-review/' + alepayRequest.token,
            type: 'post',
            data: {
                _csrf: alepayRequest.csrf,
                cardImage: cardImage,
